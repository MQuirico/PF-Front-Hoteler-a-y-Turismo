...
export default function About(props) {
  return (
    <div className="container mt-5">
      <h1 className="text-start">Sobre Nosotros</h1>
      ...
      <h2 className="text-start">Nuestra Misión</h2>
      <p className="text-start mb-4">
        ...
        de confianza en cada paso de tu viaje, brindándote no solo las mejores
        zapatillas, sino también el conocimiento y la experiencia que necesitas
        para alcanzar tus metas.
      </p>

      <h2 className="text-start">Variedad para Todos</h2>
      <p className="text-start mb-4">
        ...
        actividades, estamos comprometidos a proporcionar la selección más
        completa para satisfacer tus demandas atléticas y de estilo.
      </p>

      <h2 className="text-start">Experiencia Personalizada</h2>
      <p className="text-start mb-4">
      ...
      <p className="text-start">
        Gracias por elegir Runners Paradise. Estamos emocionados de ser parte de tu viaje atlético y de ayudarte a alcanzar nuevas alturas.<br />
        ¡Corre con nosotros!<br />
        El equipo de Runners Paradise
      </p>
    </div>
  );
}
