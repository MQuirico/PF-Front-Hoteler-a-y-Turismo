  ...
  return (
    <div className="container">
      ...
      <nav className="nav">
        ...
        <Link to="/"><button className="bot">Home</button></Link>
      </nav>

      <section>
        
        <h2>Qué hacemos</h2>
        <p className="parrafo">En nuestro servicio, ofrecemos reservas de cabañas para unas vacaciones inolvidables. Nos especializamos en brindar experiencias únicas y acogedoras para nuestros clientes.</p>
      ...
      <section>
        ...
        <p className="parrafo">Nos enorgullecemos de ofrecer a nuestros clientes la oportunidad de registrarse y descubrir los mejores lugares para vacacionar. Cuidamos cada detalle para garantizar una experiencia única y sorprendente en cada visita.</p>
      </section>
      ...
      <section>
        ...
        <p className="parrafo">Nuestra principal prioridad es proporcionar una estancia excepcional para nuestros huéspedes. Nos esforzamos por la excelencia en cada aspecto, desde la comodidad de nuestras cabañas hasta la eficiencia de nuestro servicio.</p>
      </section>
